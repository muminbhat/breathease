...
const BookAnAppointment = () => {
  const [modalContent, setModalContent] = useState('');
    ...
    const showTerms = (e) => {
        e.preventDefault();
        setModalContent(<p><b>Terms and Conditions for Online Appointment Booking with Dr. Tarun Sharma</b><br></br> 
  ...
  return (
    <section id="bookanappointment" className="book-appointment-section" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '900px', width: '100%', margin: 'auto', flexWrap: 'wrap' }}>
        <form style={{ width: '60%', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
          ...
          <input type="email" placeholder="Email" required style={{ width: '100%' }} />
          <input type="tel" placeholder="Phone Number" required style={{ width: '100%' }} />
